...
<head>
    ...
    <style>
        ...
        .card { background-color: #ffffffff !important; border: 1px solid #dee2e6; transition: transform 0.3s ease, box-shadow 0.3s ease; }
        .card:hover { transform: translateY(-10px) scale(1.03); box-shadow: 0 15px 25px rgba(0,0,0,0.5); }
        .card .card-title, .card .card-text { color: #ffffffff; }
