        ...
        <div class="col-md-3">
            <div class="section-card">
                ...
                <ul class="list-unstyled">
                    <li><a href="{{ route('admin_it.dashboard') }}" class="sidebar-link">Dashboard</a></li>
                    <li><a href="{{ route('admin.it.users') }}" class="sidebar-link">Customer Information</a></li>
                    <li><a href="{{ route('staff.index') }}" class="sidebar-link">Staff Management</a></li>
