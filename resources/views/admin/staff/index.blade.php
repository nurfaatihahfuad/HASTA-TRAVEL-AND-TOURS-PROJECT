        ...
        <div class="card border-0 bg-primary bg-opacity-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0">{{ $staff->count() }}</h5>
        ...
        <div class="card border-0 bg-info bg-opacity-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0">{{ $staff->where('staff.staffRole', 'salesperson')->count() }}</h5>
        ...
        <div class="card border-0 bg-success bg-opacity-10">
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="card-title mb-0">{{ $staff->where('staff.staffRole', 'runner')->count() }}</h5>
