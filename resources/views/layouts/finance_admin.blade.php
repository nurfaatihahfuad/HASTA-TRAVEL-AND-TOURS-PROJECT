...
<head>
    ...
    <title>@yield('title', 'Finance Dashboard') - HASTA</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            ...
            <a class="sidebar-link @if($currentRoute == 'admin_finance.dashboard') active @endif" 
               href="{{ route('admin_admin_finance.dashboard') }}">
